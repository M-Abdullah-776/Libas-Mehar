...
router.post('/', async (req, res, next) => {
  try {
    ...
    if (!process.env.ANTHROPIC_API_KEY) {
      ...
      return res.json({
        reply: "Welcome to Libas Mehar! I am running in demo mode. To enable real Claude responses, please add your ANTHROPIC_API_KEY to the backend .env. How can I help you today?"
      });
    }
